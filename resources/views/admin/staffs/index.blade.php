...
<h2 class="salon-title mb-4 text-center">Data Staff</h2>
<div class="mb-3 text-end">
    <a href="{{ route('staffs.create') }}" class="btn btn-salon">+ Tambah Staff</a>
</div>
@if(session('success'))
    ...
    <tbody>
        @forelse($staffs as $staff)
            <tr>
                ...
                <td>
                    <a href="{{ route('staffs.edit', $staff) }}" class="btn btn-warning btn-sm">Edit</a>
