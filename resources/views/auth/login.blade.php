...
<div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
    <div class="card salon-card p-4" style="width: 400px;">
        <div class="card-body">
            <h2 class="card-title text-center mb-4 salon-title">Salon & Nail Art Login</h2>
            @if(session('success'))
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <button type="submit" class="btn btn-salon w-100">Login</button>
            </form>
            <div class="mt-3 text-center">
                <span>Belum punya akun?</span>
                <a href="{{ route('register') }}" class="link-salon">Daftar di sini</a>
            </div>
        </div>
    </div>
</div>
